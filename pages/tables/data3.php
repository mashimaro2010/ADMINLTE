        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item menu-open">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="../tables/data3.php" class="nav-link active">
                  <i class="fas fa-table nav-icon"></i>
      ...
      <div class="container-fluid">
        <div class="row">
          <div class="col-12">        
            ...
            $objConnect = MSHOCI();
            $SQLRefer="SELECT 'IN' as Ref,decode(refin.OPDIPD,'O','OPD','IPD') as Depart,TO_CHAR(decode(refin.REFERTYPE,'1',refin.REFER_NO,'')) as IN_Number,cast(refin.PAT_RUN_HN||'/'||refin.PAT_YEAR_HN as char(20)) as HN,
            o.OPD_NO as vn,TO_CHAR(refin.REFER_IN_DATETIME,'yyyy-mm-dd') as Refer_Date,TO_CHAR(o.OPD_DATE,'yyyy-mm-dd') as OPD_Date,p.PRENAME||''||p.NAME||' '||p.SURNAME as psname,
            TO_CHAR(decode(refin.REFERTYPE,'2',refin.REFER_NO,'')) as OUT_Number,
            ...
            TO_Char(p.BIRTHDAY,'yyyy-mm-dd') as BIRTHDATE,trunc(months_between(o.OPD_DATE,p.BIRTHDAY)/12)  as Age,DECODE(p.SEX, 'M','ชาย','หญิง') as sex,n.name as nat_name,
            ...
            (select odag.ICD_CODE from OPDDIAGS odag where odag.OPD_OPD_NO=refin.OPD_NO and TYPE='1' and rownum<=1) as pdx,
            (select d.PRENAME||''||d.NAME||' '||d.SURNAME from DOC_DBFS d where d.DOC_CODE=refin.DD_DOC_CODE and rownum<=1) as refer_doc_name,
            (select d.PRENAME||''||d.NAME||' '||d.SURNAME from DOC_DBFS d where d.DOC_CODE=o.DD_DOC_CODE and rownum<=1) as RX_doc_name,refin.an
	    ...
	    if($objConnect){
		$stid = oci_parse($objConnect, $SQLRefer);
		oci_execute($stid);
            ?>
              <!-- /.card-header -->
              <div class="card-body">
